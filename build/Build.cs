...
#pragma warning restore CS0649
    ...
    readonly string SonarProjectKey = "tamp-build_tamp-testcontainers";
    ...
    Target Test => _ => _
        ...
        .Description("Unit tests — diagnostic library, no external CLI/service.")
        .Executes(() => DotNet.Test(s => s
            .SetProject(RootDirectory / "tests" / "Tamp.Testcontainers.V4.Tests" / "Tamp.Testcontainers.V4.Tests.csproj")
            .SetConfiguration(Configuration)
            .SetNoBuild(true)
    ...
    Target Pack => _ => _
        ...
        {
            s.SetProject(RootDirectory / "src" / "Tamp.Testcontainers.V4" / "Tamp.Testcontainers.V4.csproj");
